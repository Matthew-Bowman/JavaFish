...
public class JavaFish implements Asset {
    /*************** FIELDS ***************/
    // DECLARE a constant String for the texture path, call it _TEXTURE_NAME:
    private static final String _TEXTURE_NAME = "./textures/JavaFish.png";
     ...
     */
    public JavaFish(float xPosition, float yPosition, float speed, float scale) throws Exception {
