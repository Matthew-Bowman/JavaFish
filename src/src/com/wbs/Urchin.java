...
public class Urchin implements Asset {
    /*************** FIELDS ***************/
    // DECLARE a constant String for the texture path, call it _TEXTURE_NAME:
    private static final String _TEXTURE_NAME = "./textures/Urchin.png";
    ...
    public static final float _LOWER_Y = 0.05f - 0.01953125f;

    // DECLARE a constant float for the lowest position on the x-axis, call it _UPPER_Y:
    public static final float _UPPER_Y = _LOWER_Y + 0.229427083333f;
     ...
     */
    public Urchin(float xPosition, float yPosition, float speed, float scale) throws Exception {
