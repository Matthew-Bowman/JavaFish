...
public class Bubble implements Asset {
    /*************** FIELDS ***************/
    // DECLARE a constant String for the texture path, call it _TEXTURE_NAME:
    private static final String _TEXTURE_NAME = "./textures/Bubble.png";
    ...
    public static final float _UPPER_Y = 10f;
     ...
     */
    public Bubble(float xPosition, float yPosition, float speed, float scale) throws Exception {
        ...
        _assetBehaviour = new VerticalMovement(xPosition, yPosition, _LOWER_Y, 10f, speed);
    }
